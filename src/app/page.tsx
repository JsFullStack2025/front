...
export default function welcome() {
    ...
    return (
        <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center p-8 sm:p-0">
            ...
            <main className="flex flex-col gap-30 row-start-2 items-center sm:items-start">
                <div className="grid grid-rows gap-10 justify-items-center sm:items-start">
                    <Card className=" white-on-small-width flex h-[100%] w-full items-center justify-between gap-8 px-8 lg:flex-row  bg-gradient-to-r from-white via-white via-40% via-transparent via-75%">
                        <p className=" basis-1/3 font-jet text-5xl fold-on-small-width text-center text-balance text-transparent bg-gradient-to-r from-primary-from to-primary-to bg-clip-text">
                            Создавайте кастомизируйте и делитесь своими визитками с помощью VISITEO. </p>
                        <Image
                            className="shadow-xl fold-on-small-width rounded-md"
                            src="/card.png"
                            alt="CardExample"
                            width={400}
                            height={585} />
                    ...
                    <motion.button className="bg-white h-15 rounded-md gap-2 px-5 has-[>svg]:px-7"
                        ...
                        whileTap={{ scale: 0.9 }}>
                        <Link href="/login"> <p className=" fold-on-small-width text-3xl text-center text-balance gradient font-jet p-1 ">
               ...
               <motion.div
                ...
                >
                    <Card className="white-on-small-width flex h-[100%] w-full items-center justify-between gap-8 px-8 lg:flex-row  bg-gradient-to-r via-transparent via-20% via-white via-60% to-white">
                        ...
                        />
                        <p className="p-3 basis-1/3 font-jet text-5xl fold-on-small-width text-center text-balance text-transparent bg-gradient-to-r from-primary-from to-primary-to bg-clip-text">
