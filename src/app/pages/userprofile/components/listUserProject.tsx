...
export default function ListUserProject({ cardList, deleteCard, createCard
}: {
    cardList: CardEntity[], deleteCard:any, createCard:any
}) {
  ...
  function editCard (event:any, idCard:number) {
    ...
    function viewCard (event:any, idCard:number) {
             event.preventDefault()
             event.stopPropagation();
             console.log(event)
        ...
        <>
            ...
            <ul className="p-6">
                ...
                <Trash2 />
                        ...
                        <button className="" onClick={()=>editCard(event, card.id)}>
                            <Pencil size={24} />
                            {/* <Image src="/img/UserProfile/edit.svg" alt="github logo" width={28} height={28} /> */}
                        </button>
                    </li>
